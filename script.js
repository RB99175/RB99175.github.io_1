...
var flagArray = [
  ...
  {
    flag: "MX",
    img: "https://www.countryflags.io/MX/flat/64.png",
    countryName: "Mexico"
  },
  {
    flag: "AD",
    img: "https://www.countryflags.io/AD/flat/64.png",
    countryName: "Andora"
  },
  {
    flag: "CN",
  ...
  {
    flag: "CK",
    img: "https://www.countryflags.io/CK/flat/64.png",
  ...
  {
    flag: "GL",
    img: "https://www.countryflags.io/GL/flat/64.png",
    countryName: "Greenland"
  },
  {
    flag: "BE",
    img: "https://www.countryflags.io/BE/flat/64.png",
    countryName: "Belgium"
  },
  {
    flag: "BT",
    img: "https://www.countryflags.io/BT/flat/64.png",
    countryName: "Bhutan"
  }
];
...
function getResults() {
  ...
  if (points >= 7 && points <= 10) {
    submitStr =
      "Your score : " + points + " " + "Hurrayyyyyyyy you did an awesome job!";
  } else if (points >= 4 && points <= 6) {
    submitStr =
      "Your score : " + points + " " + " Good Job, give it a try again!";
  } else if (points >= 0 && points <= 3) {
    submitStr =
      "Your score: " +
      points +
      " " +
      " Keep practising, you will reach your goal for sure!";
  }
  console.log("Points: " + points);
  //alert popsup with previously set string.
  //clearning the interval after the before the popup and setting the HTML to empty string (resetting the game)
  clearInterval(gameTimer);
  //setting the HTML string
  document.getElementById("countdown").innerHTML = "";
  window.alert(submitStr);
}
// creating a 60 sec interval to play the game using the setInterval function
function startGame() {
  var timeLeft = 60;
  gameTimer = setInterval(function() {
    //for creating a countdown timer, setting the HTML with the no.of seconds left.
    document.getElementById("countdown").innerHTML =
      timeLeft + " seconds remaining";
    timeLeft -= 1;
    //checking if the timeleft is less then or equal to zero and then calling the get results function
    if (timeLeft <= 0) {
      getResults();
    }
  }, 600);
